    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-bg-paper rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] overflow-hidden">
        ...
        <div className="flex h-[calc(90vh-80px)]">
          {/* 左侧：文档管理 */}
          <div className="w-1/2 border-r border-gray-200 p-6 overflow-y-auto custom-scrollbar">
            <div className="space-y-6">
              ...
              <div className="bg-bg-secondary rounded-lg p-4">
                ...
                <div
                  className="border-2 border-dashed border-gray-300 bg-bg-secondary rounded-lg p-6 text-center hover:border-gray-400 transition-colors cursor-pointer"
                ...
                >
                  ...
                  <p className="text-sm text-gray-500">
                    支持 MD, SQL, Excel, Word, PDF, JSON 等格式
                  </p>
          ...
          <div className="w-1/2 p-6 overflow-y-auto custom-scrollbar">
            {currentJob ? (
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="font-medium text-green-600">
                        {currentJob.successfulDocuments}
                      </span>
                    </div>
                    <div>
                    ...
                    <div className="p-4">
                      <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                        <div>
                          ...
                          <span className="font-medium">
                            {currentJob.results.report.totalTables}
                          </span>
                        </div>
                        <div>
                          <span className="text-text-secondary">成功率：</span>
                          <span className="font-medium">
                            {currentJob.results.report.successRate}%
                          </span>
                        </div>
                        <div>
                          <span className="text-text-secondary">处理时间：</span>
                          <span className="font-medium">
                            {currentJob.results.report.processingTime}ms
                          </span>
                        </div>
                      </div>
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-text-primary mb-2">批量导入监控</h3>
