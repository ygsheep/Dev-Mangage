...
const DataTableModal: React.FC<DataTableModalProps> = ({
  ...
  const getFieldTypeColor = (type: DatabaseFieldType) => {
    const typeColors: Record<DatabaseFieldType, string> = {
      ...
      [DatabaseFieldType.BLOB]: 'bg-gray-100 text-gray-800',
      [DatabaseFieldType.LONGBLOB]: 'bg-gray-100 text-gray-800'
    }
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] overflow-hidden">
        ...
        <div className="grid grid-cols-4 gap-4 p-6 border-b border-gray-200 bg-gray-50">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-500">字段数量</div>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-gray-500">关联关系</div>
          </div>
          <div className="text-center">
        ...
        <div className="p-6 max-h-[50vh] overflow-y-auto">
                      ...
                      <tr key={field.id} className="hover:bg-gray-50">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <span className={`font-medium ${field.isPrimaryKey ? 'text-yellow-700' : 'text-gray-900'}`}>
                              {field.name}
                            </span>
                          </div>
                        </td>
          ...
          {activeTab === 'indexes' && (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">索引管理</h3>
              <p className="text-gray-600 mb-6">
                管理数据表的索引信息，优化查询性能
              </p>
          ...
          {activeTab === 'sql' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-medium text-gray-900">CREATE TABLE 语句</h3>
                <button 
