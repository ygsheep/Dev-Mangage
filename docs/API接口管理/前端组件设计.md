                  ...
                  {tabs.map(tab => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="hidden sm:inline">{tab.label}</span>
                        {tab.count !== undefined && (
                          <span className="bg-gray-100 text-gray-600 px-1.5 py-0.5 text-xs rounded">
                            {tab.count}
                          </span>
                        )}
                      </TabsTrigger>
    ...
    persist(
      (set, get) => ({
        ...
        setEndpoints: (endpoints) => 
          set({ endpoints }, false, 'setEndpoints'),
        ...
        updateEndpoint: (id, updates) =>
          set(
            (state) => ({
              ...
              selectedEndpoint: state.selectedEndpoint?.id === id
        ...
        selectEndpoint: (endpoint) =>
          set({ selectedEndpoint: endpoint }, false, 'selectEndpoint'),
